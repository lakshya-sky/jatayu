...
pub struct ConsensusParams {
    ...
    max_txn_life: u64,
    approved_upgrades: HashMap<ConsensusVersion, u64>,
    ...
    #[serde(with = "from_nano_sec")]
    fast_recovery_lambda: Duration,
    payset_commit: PaysetCommitType,
    max_timestamp_increment: i64,
    ...
    compact_cert_weight_threshold: u64,
